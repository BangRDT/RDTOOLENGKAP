...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR  :  BANG RDT "$i"                    "
echo $i""$pu"  WhatsApp:  082349xxxxx"$i"                "
echo $i""$pu"  GMAIL   :  BANGRDT175@GMAIL.COM "$i"     "
echo $i""$pu"  YOUTUBE :  BANG RDT"$i"                 "
echo $pur"==================="$cy" ============================="
echo
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/BANGRDT/sub-bot.git
cd sub-bot
php sub-bot.php
fi
...
sleep 2
echo $ku"Facebook :"$i" BANG RDT"
echo $ku"YouTube  :"$i" BANG RDT"
echo $ku"WhatsApp :"$i" 082349xxx"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { BANG RDT }"
exit
fi